...
| **R26** | Non-diagnostic terminology and mandatory medical disclaimer | Phases 3, 5–6, 8 | **Phase 3 Verified** | Prominently rendered non-diagnostic disclaimer in footer; truthful confidence disclosure in AI Analysis. |
| **R27** | Future Qualcomm Snapdragon NPU deployment architecture note | Phases 3, 5, 9 | **Phase 3 Documented** (AI Analysis) | Transparent note in AI Analysis on Snapdragon NPU / Qualcomm AI Hub ONNX runtime execution contract. |
